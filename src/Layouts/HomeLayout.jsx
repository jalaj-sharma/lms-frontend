                ...
                <ul className="menu p-4 w-48 h-[100%] sm:w-80 bg-base-200 text-base-content relative">
                    ...
                    {!isLoggedIn && (
                        ...
                        <div className="w-full flex items-center justify-center ">
                            <button className="btn btn-primary px-4 py-1 font-semibold rounded-md text-white w-1/2">
                                <Link to={"/login"}>Login</Link>
                            </button>
                            <button className=" btn btn-secondary px-4 py-1 font-semibold rounded-md text-white w-1/2">
